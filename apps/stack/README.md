...
Run [**Happier**](https://cloud.happier.dev) locally and access it remotely and securely (using Tailscale).
...
([https://cloud.happier.dev](https://cloud.happier.dev)) and [configure it to use
