  ...
  newSession: {
    ...
    server: {
        ...
        relayDrift: {
            ...
            bannerAccountMismatchDescription: ({ relay, account, appAccount }: { relay: string; account: string; appAccount: string }) => `Aquest ordinador està connectat a ${relay} com a ${account}, no com a ${appAccount}.`,
            ...
            connectHereAction: 'Connecta aquest ordinador aquí',
            connectedElsewhere: ({ relay }: { relay: string }) => `Aquest ordinador està connectat a ${relay}.`,
            connectedElsewhereAs: ({ relay, account }: { relay: string; account: string }) => `Aquest ordinador està connectat a ${relay} com a ${account}.`,
            serviceConnectedElsewhere: ({ relay }: { relay: string }) => `El servei en segon pla està connectat a ${relay}.`,
...
settingsSession: {
    ...
    updates: {
        ...
        row: {
            ...
            lostConnection: 'S’ha perdut la connexió amb aquesta màquina. Potser encara s’està actualitzant.',
        ...
        confirmRemote: {
            title: 'Vols actualitzar una altra màquina?',
            message: ({ machines }: { machines: string }) => `Això actualitza el programari a ${machines}. Després d’actualitzar la línia d’ordres, el seu servei en segon pla es reinicia i les sessions en curs s’hi aturen un moment.`,
            sessions: ({ count }: { count: number }) => plural({ count, singular: 'Ara hi ha 1 sessió en curs allà.', plural: `Ara hi ha ${count} sessions en curs allà.` }),
        },
        tray: {
    ...
    setupSurface: {
        ...
        blockedServiceConflictStatus: 'Primer cal resoldre un altre servei en segon pla d’aquest ordinador. S’ha deixat tal com estava: obre Detalls per veure quin és.',
        blockedConsentDeclinedStatus: 'La configuració s’ha aturat. El servei en segon pla que ja hi havia en aquest ordinador s’ha deixat tal com estava.',
        blockedAccountKeptStatus: 'La configuració s’ha aturat. Aquest ordinador continua connectat al compte amb què té la sessió iniciada.',
        ...
        relayMoveBodyFromTo: ({ from, to }: { from: string; to: string }) => `El servei en segon pla d’aquest ordinador està connectat a ${from}. El vols moure a ${to}? Deixarà de respondre a ${from}.`,
        accountMoveTitle: ({ account }: { account: string }) => `Vols canviar aquest ordinador a ${account}?`,
    ...
    review: {
      ...
      machine: {
        ...
        thisComputer: {
            ...
            cliOldCopyRemove: ({ path, command }: { path: string; command: string }) => `Encara instal·lada a ${path}. Elimina-la amb ${command}`,
            cliOldCopyPath: ({ path }: { path: string }) => `Encara instal·lada a ${path}.`,
