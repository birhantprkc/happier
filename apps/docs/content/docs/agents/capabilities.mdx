...
| **Auggie** | Experimental | Experimental | — | Experimental (`shell_bridge`) | — |
| **Qwen Code** | Yes | Experimental | — | Experimental (`shell_bridge`) | — |
| **Kimi** | Yes | Experimental | — | Experimental (`native_mcp`) | — |
| **Kilo** | Yes | Experimental | — | Experimental (`shell_bridge`) | — |
...
| **Copilot** | Yes | Experimental | — | Experimental (`shell_bridge`) | — |
| **Cursor** | Yes | — | Yes | Experimental (`shell_bridge`) | — |
