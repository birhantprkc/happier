 ...
 * - 1M-capable: Fable 5 and later, Opus 4.6 and later, Sonnet 5, Sonnet 4.6.
 * - Always-1M on the API (no opt-in needed): Opus 5 and later, Sonnet 5, Fable 5 and later, Opus 4.8, Opus 4.7 — the explicit
